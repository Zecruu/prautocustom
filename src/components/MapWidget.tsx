      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 text-lg">
            Find us in Carolina, Puerto Rico
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-8 border border-white/10">
            <h3 className="text-2xl font-bold text-white mb-6">Our Address</h3>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-white font-medium">Carr 190 RR2 Box 327</p>
                  <p className="text-gray-400">Carolina, PR 00983</p>
                  <p className="text-gray-400">Puerto Rico</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-white font-medium">+1 787-420-5538</p>
            ...
            <a
              ...
              className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-gradient-to-r from-white to-gray-200 text-black font-bold rounded-lg hover:shadow-lg transition-all duration-300"
            >
