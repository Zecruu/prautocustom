  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed z-50 p-1.5 bg-yellow-500 hover:bg-yellow-600 rounded-md text-black transition-all duration-300 shadow-md ${
          isSidebarOpen ? 'top-4 left-[218px] lg:left-[218px]' : 'top-4 left-4'
        }`}
